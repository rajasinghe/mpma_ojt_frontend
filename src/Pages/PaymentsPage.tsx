                                  ...
                                  <tr key={index}>
                                    ...
                                    <td>
                                      ...
                                      <Link
                                        ...
                                        className={`btn btn-sm d-flex align-items-center justify-content-center px-2 py-1 ${paymentSummary.includes(Number(trainee.ATT_NO)) ? 'btn-outline-primary' : 'btn-outline-warning'}`}
                                        title={paymentSummary.includes(Number(trainee.ATT_NO)) ? 'Add to list' : 'View details'}
                                      >
